          ...
          ?></h1>
                ...
                <span class="share-bar">
                    ...
                    <span style="position: absolute;">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo url_actual()?>"
                                    target="_blank" style="background-image: url('public/imgs/facebook.svg');"></a></li>
                            ...
                            <li><a target="_blank"
                                    href="https://api.whatsapp.com/send?text=Hola!%20te%20Env%C3%ADo%20este%20interesante%20link%20<?php echo url_actual()?>"
                                    style="background-image: url('public/imgs/whatsapp.svg');"></a></li>
                        </ul>
                    </span>
                </span>
            ...
            ?>
                ...
                <video class="videomodule" width="100%" preload="auto" controls="controls" controlslist="nodownload"
                    poster="<?php echo base_url('public/imgs/poster_estandar.jpg'); ?>">
          ...
          ?>
            ...
            <div class="col-lg-4 content-detail pt">
                <div style="display: block;overflow: hidden;margin-bottom: 10px;">
                    <i class="fas fa-heart fav <?php echo $class; ?>" style="float: right;"
                        data-idcurso="<?php echo $idcurso; ?>"> <span style="font-family: 'Figtree', sans-serif;"
                            id="fav-<?php echo $idcurso; ?>"><?php echo $total_favorites; ?> me gusta</span></i>

                </div>

                <ul style="display: block;">
                    <li>Autor: <strong><a
                                href="<?php echo base_url($client_slug);?>"><?php echo $client_name; ?></a></strong>
                    </li>
                    <li>Precio:
                        <strong><a><?php if($price != 'Cotizar'){echo formateaMoneda($price);}else{echo "Cotizar";}?></a></strong>
                    </li>
                ...
                <div id="login-button" class="button form" data-toggle="modal" data-target="#contact">Contactar >></a>
                    <?php }else{?>
                    <div style="background-color: #b1b1b1; cursor: not-allowed;" class="button form"
                        data-toggle="modal">Inicie sesión para contactar</a>
                        <?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action=<?php echo base_url("cmessages/sendMessage")?> method="post" role="form"
                    data-toggle="validator" id="contact-form">
                    ...
                    <div class="acount-group">
                        ...
                        <textarea name="message" class="form-control" placeholder="Escribe tu consulta" required
                            style="height: 200px;" id="message"></textarea>
                    </div>
                    <div class="form-group input-group-lg acount-group">
                        <label>Password:</label>
                        <input type="password" name="passUser" class="form-control" placeholder="Password" id="password"
                            required>
                    </div>
