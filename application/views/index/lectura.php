      ...
      <div class="col-md-12 content-detail">
        ...
        <form action="<?php echo base_url("cmessages/getTheMessage") ?>" method="post" role="form" data-toggle="validator" id="contact-form">
          <div class="acount-group">
            <span><strong>De: </strong><?php echo $datos["from"]; ?></span>
            <span><strong>Para: </strong><?php echo $datos["to"]; ?></span>
            <span><strong>Asunto:</strong> Consulta <?php echo  $datos["course"] ?></span>
            <span><strong>Mensaje / Consulta:</strong> <?php echo trim($datos["content"]); ?></span>
          </div>
          ...
          <input type="hidden" name="idm" value="<?php echo $datos["message_id"]; ?>">
          <input type="hidden" name="subject" value="RE: Consulta curso">
          <button type="submit" class="button-primary" id="enviar-form">Enviar respuesta >></button>
        </form>
