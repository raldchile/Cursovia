...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Titillium+Web:ital,wght@0,200;0,300;0,400;0,600;0,700;0,900;1,600&display=swap"
        rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Bitter:wght@800&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Archivo:ital,wght@0,400;0,600;1,400;1,600&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <video class="home" src="<?php echo base_url("/public/video/RALD_video.mp4") ?>" autoplay="true" muted="true"
        loop="true"></video>

    <section class="barra sect">
        <div class="container">
            <div class="row">
                <div class="col-md-6"><a href="<?php echo base_url(); ?>" class="no-view-logo"><img
                            src="<?php echo base_url("public/imgs/logo_cursovia-fiwh.svg")?>"
                            class="Logotipo curso"></a></div>
                <div class="col-md-6">
                    <ul class="menu">
                        ...
                        if($validated){ ?>
                        <li class="header-button"><a href="<?php echo base_url("cursos-favoritos")?>"
                                class="fa-heart-menu white">Ver Favoritos <span
                                    id="cantfav">(<?php echo $cant_favorites; ?>)</span></a></li>
                        <li class="header-button"><a href="javascript:void(0);"
                                class="fa-user white"><?php echo $sessionuser["full_name"]; ?></a>
                            <ul class="submenu">
